...
(function () {
  window.errorMessage = function (message) {
    var errorTemplate = '<div class="error-message" style="position:fixed;left:0;right:0;top:0;bottom:0;background:rgba(0, 0, 0, 0.62);display: flex;justify-content:center;align-items:center;">' +
